...
while True:
    ...
    cv2.putText(
        frame, f"People Count: {peopleCount}", (550, 30), font, 1.5, (0, 0, 255), 2
    )
    cv2.putText(
        frame, f"Entered Count: {enteredPeople}", (550, 60), font, 1.5, (0, 0, 255), 2
    )
    cv2.putText(
        frame, f"Exited Count: {exitedPeople}", (550, 90), font, 1.5, (0, 0, 255), 2
    )
